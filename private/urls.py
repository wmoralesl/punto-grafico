...
from .views import  HomeViewPrivate, EditConfigurationView, ConfigurationView, MyProfileView, EditProfileView, CustomPasswordChangeView, MyUserActionLogView, UserActionLogView
